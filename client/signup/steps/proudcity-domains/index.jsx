...
module.exports = React.createClass( {
	displayName: 'ProudcityDomainsStep',
	...
	render: function() {
		...
		return (
			<StepWrapper
				...
				subHeaderText={ this.translate( 'Now, let\'s find a domain.' ) }
				fallbackHeaderText={ this.translate( 'Let\'s find a domain.' ) }
				fallbackSubHeaderText={ this.translate( 'You can select from a proudcity.com subdomain during your free BETA. When you launch, you can choose any domain you like.' ) }
				stepContent={ content } />
		);
	}
} );
