...
// svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><g><path d=""/></g></svg>;
	...
	render: function() {
		...
		switch ( icon ) {
			...
			case 'gridicons-bell':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><g><path d="M912 1696q0-16-16-16-59 0-101.5-42.5t-42.5-101.5q0-16-16-16t-16 16q0 73 51.5 124.5t124.5 51.5q16 0 16-16zm816-288q0 52-38 90t-90 38h-448q0 106-75 181t-181 75-181-75-75-181h-448q-52 0-90-38t-38-90q50-42 91-88t85-119.5 74.5-158.5 50-206 19.5-260q0-152 117-282.5t307-158.5q-8-19-8-39 0-40 28-68t68-28 68 28 28 68q0 20-8 39 190 28 307 158.5t117 282.5q0 139 19.5 260t50 206 74.5 158.5 85 119.5 91 88z"/></g></svg>;
				break;
			...
			case 'gridicons-create':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><g><path d="M1600 736v192q0 40-28 68t-68 28h-416v416q0 40-28 68t-68 28h-192q-40 0-68-28t-28-68v-416h-416q-40 0-68-28t-28-68v-192q0-40 28-68t68-28h416v-416q0-40 28-68t68-28h192q40 0 68 28t28 68v416h416q40 0 68 28t28 68z"/></g></svg>;
				break;
			...
			case 'gridicons-menu':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><g><path d="M1664 1344v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45zm0-512v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45zm0-512v128q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45z"/></g></svg>;
				break;
			...
			case 'gridicons-my-sites-horizon':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72"><g><path d="M36.021,12c-13.234,0-24,10.766-24,24c0,13.233,10.766,24,24,24h0.802l-7.151-16.951
				c2.48-3.713,6.685-2.803,6.685-2.803c0.085,2.372,0.127,4.098,0.127,4.098c4.05-2.004,7.792-1.923,11.37-3.33
				c4.166-1.638,1.143-14.514,0.655-14.199c-5.129,3.3-8.373,2.929-8.373,2.929c0.391-1.14,0.442-2.18-0.33-3.61
				c-0.772-1.43-2.883-2.118-7.619-2.118c-5.505,0-10.169,3.319-10.169,3.319l10.314,29.877C22.213,55.456,14.492,46.614,14.492,36
				c0-11.871,9.658-21.529,21.529-21.529S57.551,24.129,57.551,36c0,5.749-2.866,10.579-7.864,13.254
				c-3.715,1.988-8.06,2.428-12.231,1.382c-0.863-0.216,0.47,2.656,1.357,2.79c4.144,0.628,8.356-0.022,12.04-1.993
				c5.741-3.073,9.169-8.842,9.169-15.433C60.022,22.766,49.255,12,36.021,12z"/></g></svg>;
				//svg = <img src="https://my.proudcity.com/images/IconBlack.png" className={ iconClass } height={ this.props.size } width={ this.props.size } />;
				break;
			case 'gridicons-my-sites':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="10 10 52 52"><g><path d="M36.021,12c-13.234,0-24,10.766-24,24c0,13.233,10.766,24,24,24h0.802l-7.151-16.951
				c2.48-3.713,6.685-2.803,6.685-2.803c0.085,2.372,0.127,4.098,0.127,4.098c4.05-2.004,7.792-1.923,11.37-3.33
				c4.166-1.638,1.143-14.514,0.655-14.199c-5.129,3.3-8.373,2.929-8.373,2.929c0.391-1.14,0.442-2.18-0.33-3.61
				c-0.772-1.43-2.883-2.118-7.619-2.118c-5.505,0-10.169,3.319-10.169,3.319l10.314,29.877C22.213,55.456,14.492,46.614,14.492,36
				c0-11.871,9.658-21.529,21.529-21.529S57.551,24.129,57.551,36c0,5.749-2.866,10.579-7.864,13.254
				c-3.715,1.988-8.06,2.428-12.231,1.382c-0.863-0.216,0.47,2.656,1.357,2.79c4.144,0.628,8.356-0.022,12.04-1.993
				c5.741-3.073,9.169-8.842,9.169-15.433C60.022,22.766,49.255,12,36.021,12z"/></g></svg>;
				//svg = <img src="https://my.proudcity.com/images/IconWhite.png" className={ iconClass } height={ this.props.size } width={ this.props.size } />;
				break;
			...
			case 'gridicons-phone':
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 2"><g><path d="M16 2H8c-1.104 0-2 .896-2 2v16c0 1.104.896 2 2 2h8c1.104 0 2-.896 2-2V4c0-1.104-.896-2-2-2zm-3 19h-2v-1h2v1zm3-2H8V5h8v14z"/></g></svg>;
				break;
			case 'gridicons-plugins':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><g><path d="M1755 453q37 37 37 90t-37 91l-401 400 150 150-160 160q-163 163-389.5 186.5t-411.5-100.5l-362 362h-181v-181l362-362q-124-185-100.5-411.5t186.5-389.5l160-160 150 150 400-401q38-37 91-37t90 37 37 90.5-37 90.5l-400 401 234 234 401-400q38-37 91-37t90 37z"/></g></svg>;
				break;
			...
			case 'gridicons-stats-alt':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><g><path d="M512 896v512h-256v-512h256zm384-512v1024h-256v-1024h256zm1024 1152v128h-2048v-1536h128v1408h1920zm-640-896v768h-256v-768h256zm384-384v1152h-256v-1152h256z"/></g></svg>;
				break;
			...
			case 'gridicons-user':
				...
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><g><path d="M1600 1405q0 120-73 189.5t-194 69.5h-874q-121 0-194-69.5t-73-189.5q0-53 3.5-103.5t14-109 26.5-108.5 43-97.5 62-81 85.5-53.5 111.5-20q9 0 42 21.5t74.5 48 108 48 133.5 21.5 133.5-21.5 108-48 74.5-48 42-21.5q61 0 111.5 20t85.5 53.5 62 81 43 97.5 26.5 108.5 14 109 3.5 103.5zm-320-893q0 159-112.5 271.5t-271.5 112.5-271.5-112.5-112.5-271.5 112.5-271.5 271.5-112.5 271.5 112.5 112.5 271.5z"/></g></svg>;
				break;
