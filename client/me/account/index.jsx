...
module.exports = React.createClass( {
	...
	hadFormError: function() {
		return this.state.emailValicationError;
	},
	...
	updateEmailAddress: function() {
		return {
			...
			requestChange: function( value ) {
				if ( '' === value ) {
					this.setState( { emailValicationError: 'empty' } );
				} else if ( ! emailValidator.validate( value ) ) {
					this.setState( { emailValicationError: 'invalid' } );
				} else {
					this.setState( { emailValicationError: false } );
				}
	...
	renderEmailValidation: function() {
		...
		if ( ! this.state.emailValicationError ) {
			return null;
		}
		let notice;
		switch ( this.state.emailValicationError ) {
			case 'invalid':
			...
			<div className="account__settings-form" key="settingsForm">
				<FormFieldset>
					...
					<FormTextInput
						...
						id="email"
						name="email"
						isError={ !! this.state.emailValicationError }
